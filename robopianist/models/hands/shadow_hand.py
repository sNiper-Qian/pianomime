...
_DEFAULT_FOREARM_DOFS = ("forearm_tx", "forearm_ty", "forearm_tz")
...
class ShadowHand(base.Hand):
    ...
    def _add_mjcf_elements(self) -> None:
        # Add sites to the wrist
        wrist_elem = mjcf_utils.safe_find(self._mjcf_root, "body", self._prefix + "wrist")
        wrist_site = wrist_elem.add(
            "site",
            name="wrist_site",
            pos=(0.0, 0.0, 0.0),
            type="sphere",
        ...
        # Add site to the forearm.
        forearm_site = self.root_body.add(
            "site",
            name="forearm_site",
            pos=(0.0, 0.0, 0.0),
            type="sphere",
        ...
        self._forearm_site = forearm_site
    ...
    @property
    def forearm_site(self) -> types.MjcfElement:
        return self._forearm_site
