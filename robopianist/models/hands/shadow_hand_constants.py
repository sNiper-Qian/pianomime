...
TH_TIP_LENGTH = 0.03
FF_TIP_LENGTH = 0.0225
MF_TIP_LENGTH = 0.025
RF_TIP_LENGTH = 0.025
LF_TIP_LENGTH = 0.0225
TH_PARENT_LENGTH = 0.04
FF_PARENT_LENGTH = 0.025
MF_PARENT_LENGTH = 0.028
RF_PARENT_LENGTH = 0.0275
LF_PARENT_LENGTH = 0.0225
TIP_LENGTHS = [TH_TIP_LENGTH, FF_TIP_LENGTH, MF_TIP_LENGTH, RF_TIP_LENGTH, LF_TIP_LENGTH]
PARENT_LENGTHS = [TH_PARENT_LENGTH, FF_PARENT_LENGTH, MF_PARENT_LENGTH, RF_PARENT_LENGTH, LF_PARENT_LENGTH]
