...
class PianoTask(PianoOnlyTask):
    ...
    def __init__(
        ...
        # noised_rh = [_RIGHT_HAND_POSITION[i] + random.uniform(-0.03, 0.03) for i in range(2)]
        # noised_rh.append(_RIGHT_HAND_POSITION[2])
        # noised_lh = [_LEFT_HAND_POSITION[i] + random.uniform(-0.03, 0.03) for i in range(2)]
        # noised_lh.append(_LEFT_HAND_POSITION[2])
